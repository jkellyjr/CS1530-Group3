...
#
#     user = db.relationship('User', backref=db.backref("rating", lazy='dynamic'), lazy='joined')
#     tutor = db.relationship('Tutor', backref=db.backref("rating", lazy='dynamic'), lazy='joined')
#     group = db.relationship('Group', backref=db.backref("rating", lazy='dynamic'), lazy='joined')
#
